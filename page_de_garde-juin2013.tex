...
\thispagestyle{empty}
\vspace*{\stretch{2}}
\noindent Remerciements à M. \textsc{Martel} pour son cours, M. \textsc{Barani} pour ses conseils \LaTeX \\
(\texttt{http://jean-pierre.barani.pagesperso-orange.fr/}) et M. \textsc{Pierrefeu} à qui nous souhaitons une bonne retraite! \\

\vspace*{\stretch{2}}
\noindent Le code \LaTeX\ de ce document est accessible gratuitement à l'adresse suivante: \\ \texttt{http://github.com/alexmick/chimie.spe}
\vspace*{\stretch{2}}
\begin{center}
\noindent \copyright\ \today
\end{center}
Ce document et son code source sont mis à disposition selon les termes de la Licence Creative Commons Attribution,  pas d'Utilisation Commerciale et Partage dans les Mêmes Conditions 3.0 non transposé:\\
