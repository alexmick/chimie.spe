...
\usetikzlibrary{decorations.pathmorphing} %Permet de créer les liaisons ondulées
...
{$\left.\vrule height\delimhalfdim depth\delimhalfdim width0pt\right\delimright_{\rlap{$\scriptstyle#3$}}$};}} \setpolymerdelim() %Permet de créer les délimiteurs pour les polymères
\newcommand\moyenne[1]{\langle#1\rangle} %Nombre moyen de 
%% Environnements personalisés
\newenvironment{scheme}[2]
{\begin{center}\schemestart[#1,#2]}
{\schemestop\end{center}}  
