...
\begin{center}
	\schemestart
		...
		\chemfig{(-[:210])(=[:90]O)-[@{a1}:-30]\lewis{57,O}-[@{a2}:30](-[@{b1}:90]@{b2}O^\oplus-\chembelow{Al}{\scriptstyle\ominus}Cl_3)-[:-30]}
		\chemmove[->]{
...
\begin{center}
	\schemestart
	\chemfig{[:-30,0.7]*6(=-=(-H)-=-)} \+ \chemfig{\lewis{35,O}=\chemabove{N}{\scriptsize\oplus}=\lewis{17,O}}
	\arrow[,0.7]
	\chemfig{[:-30,0.7]*6(=-(-[,-0.2,,,draw=none]\scriptstyle\oplus)(-[,0.2,,,draw=none]\lewis{7|,})-(-[:45]H)(-[:-45]\chemabove{N}{\scriptsize\oplus}(=[:-90]\lewis{57,O})-\lewis{026,O^\ominus})-=-)}
	\arrow{->[\chemfig{\lewis{246,O}^\ominus-S(=[:90]O)(=[:-90]O)-OH}][]}
	\chemfig{[:-30,0.7]*6(=-=(-\chemabove{N}{\scriptstyle\oplus}(=[:45]\lewis{02,O})-[:-45]\lewis{157,O}^\ominus)-=-)}
	\+ H$_2$SO$_4$
	\schemestop
\end{center}
