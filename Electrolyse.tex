...
\item Réaction possibles : À l'anode,
					...
					\end{center}
\item Prévisions thermodynamiques : Les réactions qui se déroulent majoritairement sont celles qui demandent le moins d'énergie, ce qui correspond à celles de plus forte affinité chimique. L'affinité chimique est maximale si l'affinité de la cathode est maximale et celle de l'anode minimale (avec $\A = F.E$). La thermo prévoit donc la réduction de l'espèce avec le potentiel de \bsc{Nernst} le plus élevé (parmi les réactions possibles à la cathode) et l'oxydation de l'espèce avec le potentiel de \bsc{Nernst} le moins élevé (parmi les réactions possibles à l'anode). \end{itemize}
...
\end{center}
\vspace{0.5cm}
Un système est lent s'il existe un domaine de potentiel tel que j=0. On appelle surtension la différence $\eta = E-E_{eq}$ pour une valeur de j donnée mais conventionnellement, si rien n'est précisé, il faut comprendre \og quand j arrête d'être nul \fg. La surtension anodique est positive, la surtension cathodique est négative. 
\begin{center}
